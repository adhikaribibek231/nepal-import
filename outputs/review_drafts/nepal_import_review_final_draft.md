...
- IP rating mismatch: the test report identifies IP67, while the certificate identifies IP65.
- Manufacturer and certificate identity should be confirmed: the test report names Zhejiang CHISAGE New Energy Technology Co., Ltd as manufacturer, while the certificate holder is NingBo Deye Inverter Technology Co., Ltd.
