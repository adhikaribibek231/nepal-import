...
ConflictStatus = Literal["consistent", "conflict", "partial_match", "missing_in_one_source", "needs_confirmation"]
RequirementStatus = Literal["evidence_found", "partial","missing","needs_confirmation","not_assessed"]
